...
export class TraineeProfileComponent implements OnInit {
  ...
  navigatingToUpdatePage() {
    this.router.navigate(['/update-trainee-profile'], {state: {trainee: this.trainee}});
  }

  navigatingToUpdatePassword() {
    this.router.navigate(['/update-trainee-password'], {state: {traineeDetails: this.trainee}});
  }

  addTrainersToTrainee() {
    this.router.navigate(['/update-trainee-trainers'], {state: {trainee: this.trainee}});
  }
}
